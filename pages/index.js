...
import { Container, Row, Col, ListGroup, Stack, Form, Button, Modal, FormLabel, FormControl } from 'react-bootstrap';
        ...
        <Modal.Body>
          <Form onSubmit={(e) => { e.preventDefault() }}>
            <Form.Group className='mb-3'>
              ...
              <FormControl type='text' value={inputTitle} onChange={(e) => setInputTitle(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3">
              <FormLabel>Descrição da Tarefa</FormLabel>
              <FormControl as="textarea" rows={4} value={inputDescription} onChange={(e) => setInputDescription(e.target.value)} />
            </Form.Group>
          </Form>
        </Modal.Body>
